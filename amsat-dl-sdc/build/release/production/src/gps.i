...
u8 eidx=0;
 ...
 u8 chksumgps = strtol(gpsbuf + (strlen(gpsbuf)-2),((void*)0),16);
...
u8 gps_config_data[] =
{
 ...
 (u8)((19000000 + 35) & 0xff),
 (u8)(((19000000 + 35)>>8)&0xff),
 (u8)(((19000000 + 35)>>16)&0xff),
 (u8)(((19000000 + 35)>>24)&0xff),
...
{
 u8 idx = 12;
 gps_config_data[idx++] = (u8)(19000000 & 0xff);
 gps_config_data[idx++] = (u8)((19000000>>8)&0xff);
 gps_config_data[idx++] = (u8)((19000000>>16)&0xff);
 gps_config_data[idx++] = (u8)((19000000>>24)&0xff);
}
...
static char grid[7];
 ...
 u32 lon = ((GPS_lon[0]-'0')*100) + ((GPS_lon[1]-'0')*10) + ((GPS_lon[2]-'0')*1);
 u32 lon_min = ((GPS_lon[4]-'0')*10) + ((GPS_lon[5]-'0')*1);
 lon_min *= 100;
 lon_min += (((GPS_lon[7]-'0')*10) + ((GPS_lon[8]-'0')*1));
 lon_min = (lon_min * 100) / 60;
 lon = lon*10000 + lon_min;
 ...
 u32 lat = ((GPS_lat[0]-'0')*10) + ((GPS_lat[1]-'0')*1);
 u32 lat_min = ((GPS_lat[3]-'0')*10) + ((GPS_lat[4]-'0')*1);
 lat_min *= 100;
 lat_min += (((GPS_lat[6]-'0')*10) + ((GPS_lat[7]-'0')*1));
 lat_min = (lat_min * 100) / 60;
 lat = lat*10000 + lat_min;
