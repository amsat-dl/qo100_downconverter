...
# 2 "<built-in>" 2
# 1 "src/driver/adf4351.c" 2
# 15 "src/driver/adf4351.c"
# 1 "src/config.h" 1
# 11 "src/config.h"
...
static __attribute__((inline)) u32 gcd(u32 a, u32 b);
...
void adf4351_init(adf4351_ctx* ctx)
{
 ...
 adf4351_default(ctx);
    ...
    _delaywdt((unsigned long)((100)*(8000000/4000000.0)));
}

static u32 g_freq = 0;
# 86 "src/driver/adf4351.c"
int adf4351_set_freq(adf4351_ctx* ctx, u32 freq)
{

 if(!ctx->init) return -3;
 ...
 ctx->reg2.refdbl = 0;
 ctx->reg3.bscm = 0;
 ctx->reg4.bsclkdiv = (40000/ctx->reg2.rcnt)/125+1;
...
{
 return (((*((PIN_ADF_LOCK)->pPORT) & (PIN_ADF_LOCK)->mask) != 0)==0)?0:1;
}
...
void check_ADF5341_status(adf4351_ctx* ctx)
{
 ...
 u8 stat = ((*((PIN_ADF_LOCK)->pPORT) & (PIN_ADF_LOCK)->mask) != 0);
...
# 367 "src/driver/adf4351.c"
static void adf4351_write_latch(u32 value)
{
    u32 mask = 0x80000000ULL;

    *((PIN_SIO_CLK)->pPORT) &= ~(PIN_SIO_CLK)->mask;
    _delaywdt((unsigned long)((1)*(8000000/4000000.0)));
 ...
 *((PIN_ADF_LE)->pPORT) |= (PIN_ADF_LE)->mask;
 _delaywdt((unsigned long)((1)*(8000000/4000000.0)));
 *((PIN_ADF_LE)->pPORT) &= ~(PIN_ADF_LE)->mask;
 _delaywdt((unsigned long)((50)*(8000000/4000000.0)));
}
