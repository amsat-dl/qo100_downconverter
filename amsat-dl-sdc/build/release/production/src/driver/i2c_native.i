...
# 2 "<built-in>" 2
# 1 "src/driver/i2c_native.c" 2
# 21 "src/driver/i2c_native.c"
# 1 "src/config.h" 1
# 11 "src/config.h"
...
# 24 "src/driver/i2c_native.c" 2
# 1 "src/driver/i2c_native.h" 1
# 11 "src/driver/i2c_native.h"
...
static void i2c_reset(i2c_data_native *ctx)
{
 ...
 TRISC |= 0b00011000;
    ...
    reg = (8000000 / (4*ctx->baud)) - 1;
    SSPADD = (reg<127)?reg:127;

    SSPCON1bits.SSPEN = 1;
}
# 95 "src/driver/i2c_native.c"
static int i2c_wait_int(u32 timeout)
{
...
static int i2c_transfer_native(i2c_dev dev, i2c_msg *msg, int num)
{
 ...
 for(i=0;i<num;i++) {
  ...
  pmsg = &msg[i];
  bdata = (u8*)pmsg->data;
  read = ((pmsg->flags & (1<<0)) != 0);
  wantack = ((pmsg->flags & (1<<3)) == 0);
