...
extern u8 ubx_ack;
extern char GPS_lat[15];
extern char GPS_lon[15];
# 21 "src/driver/si5328.c" 2
# 1 "src/driver/i2c_native.h" 1
...
# 22 "src/driver/si5328.c" 2
# 1 "src/secretsettings.h" 1
# 15 "src/secretsettings.h"
void secret_settings(void);

extern u8 special_cfg;
extern u8 tcxo_no_GPS;
# 23 "src/driver/si5328.c" 2
# 56 "src/driver/si5328.c"
void setQRG(void);
...
u16 N2L_reg4142=1;
u16 N1HS_reg25=1;
u16 NC1_LS_reg3233=1;
u16 NC2_LS_reg3536=1;
# 168 "src/driver/si5328.c"
...
void set_reg()
{
 ...
 p[idx] = ((((N31_reg4445 - 1) >> 8)));
 idx += 2;
 p[idx] = (N31_reg4445 - 1 & 0xff);
 idx += 2;
 p[idx] = ((((N32_reg4748 - 1) >> 8)));
 idx += 2;
 p[idx] = (N32_reg4748 - 1 & 0xff);
 idx += 2;
 p[idx] = ((N2HS_reg40-4)<<5);
 idx += 2;
 p[idx] = ((((N2L_reg4142 - 1) >> 8)));
 idx += 2;
 p[idx] = (N2L_reg4142 - 1 & 0xff);
 idx += 2;
 p[idx] = ((N1HS_reg25-4)<<5);
 idx += 2;
 p[idx] = ((((NC1_LS_reg3233 - 1) >> 8)));
 idx += 2;
 p[idx] = (NC1_LS_reg3233 - 1 & 0xff);
 idx += 2;
 p[idx] = ((((NC2_LS_reg3536 - 1) >> 8)));
 idx += 2;
 p[idx] = (NC2_LS_reg3536 - 1 & 0xff);
 idx += 2;
}
...
int si5328_init(i2c_dev i2c, u8 addr)
{
    ...
    if(res == 0)
 {
  ...
  if(ext10MHzReference == 0)
  {
   ...
   write_regset(i2c, addr, reg_set_univ_CKIN2_XAXB, (sizeof(reg_set_univ_CKIN2_XAXB)/sizeof(reg_set_univ_CKIN2_XAXB[0])));
  }
  else
  {

   write_regset(i2c, addr, reg_set_univ_CKIN1_GPS, (sizeof(reg_set_univ_CKIN1_GPS)/sizeof(reg_set_univ_CKIN1_GPS[0])));
  }
...
void si5328_set_freq(i2c_dev i2c, u8 addr, u8 freq_MHz)
{
 ...
 write_regset(i2c, addr, reg_set_LNB_LO, (sizeof(reg_set_LNB_LO)/sizeof(reg_set_LNB_LO[0])));
 printf("si:LNB: %d\n",freq_MHz);
