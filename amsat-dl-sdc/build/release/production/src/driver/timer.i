...
# 2 "<built-in>" 2
# 1 "src/driver/timer.c" 2
# 25 "src/driver/timer.c"
# 1 "src/config.h" 1
# 11 "src/config.h"
...
# 31 "src/driver/timer.c" 2
# 1 "src/driver/irq.h" 1
...
void init_timer(void)
{
 ...
 irq_set_handler(IRQ_HANDLER_ID_TIMER0, t0_irq, ((void*)0));
}
