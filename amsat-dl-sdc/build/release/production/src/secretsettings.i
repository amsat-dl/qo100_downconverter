...
# 2 "<built-in>" 2
# 1 "src/secretsettings.c" 2
# 42 "src/secretsettings.c"
# 1 "src/config.h" 1
# 11 "src/config.h"
...
void secret_settings_write()
{
 ...
 if(((*((PIN_LNB_QRG2)->pPORT) & (PIN_LNB_QRG2)->mask) != 0) != 0 || ((*((PIN_LNB_QRG1)->pPORT) & (PIN_LNB_QRG1)->mask) != 0) != 0)
  return;
