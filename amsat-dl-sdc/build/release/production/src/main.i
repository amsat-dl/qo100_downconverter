...
extern void adf4351_init(adf4351_ctx* ctx);
...
void putgps(u8 c);
# 38 "src/main.c" 2
# 1 "src/driver/lcd.h" 1
# 17 "src/driver/lcd.h"
extern void lcd_init(i2c_dev i2c, u8 addr);
# 47 "src/driver/lcd.h"
...
# 41 "src/main.c" 2
# 1 "src/freq_tables.h" 1
# 16 "src/freq_tables.h"
extern const u32 freq_table_25_24[10];
extern const u32 freq_table_25_25[10];
extern const u32 freq_table_27_26[10];
extern const u32 freq_table_27_OPT[10];
# 42 "src/main.c" 2
# 1 "src/eeprom.h" 1
# 18 "src/eeprom.h"
...
void main(void)
{
 ...
 lnb_configure(&g_i2c_bus, 0x08);




    si5328_init(&g_i2c_bus, 0x68);
    ...
    adf4351_set_tune(&g_adf4351, g_ipc, g_pout, 1);


    adf4351_set_mode(&g_adf4351, 1);
    ...
    while(1)
 {
  ...
  si5328_checkGPS(&g_i2c_bus, 0x68);


  u8 lock = check_si5328_status(&g_i2c_bus, 0x68);
  ...
  check_LNB_status(&g_i2c_bus, 0x08);
...
static u8 read_switch(void)
{
    ...
    rb1 = ((*((PIN_SJ3)->pPORT) & (PIN_SJ3)->mask) != 0)?0:1;
    rb2 = ((*((PIN_SJ4)->pPORT) & (PIN_SJ4)->mask) != 0)?0:1;
    rb3 = ((*((PIN_SJ5)->pPORT) & (PIN_SJ5)->mask) != 0)?0:1;
    rb4 = ((*((PIN_SJ6)->pPORT) & (PIN_SJ6)->mask) != 0)?0:1;
...
static void setADF4351frequency(u8 force)
{
 ...
 if(sw != actualADFswitch || force || adf4351_set_qrg == 3)
 {
  ...
  adf4351_set_freq(&g_adf4351, 700000);
  _delaywdt((unsigned long)((250)*(8000000/4000.0)));

  adf4351_set_freq(&g_adf4351, p[sw]);

        while((adf4351_get_lock(&g_adf4351) == 0) && timeout)
  {
            timeout--;
...
void setQRG()
{
 ...
 u8 newLO;
    ...
    sw = ((*((PIN_LNB_QRG2)->pPORT) & (PIN_LNB_QRG2)->mask) != 0)?1:0;
 sw <<= 1;
    sw |= ((*((PIN_LNB_QRG1)->pPORT) & (PIN_LNB_QRG1)->mask) != 0)?1:0;
 ...
 if(newLO != currentLO)
 {
  ...
  currentLO = newLO;
  si5328_set_freq(&g_i2c_bus, 0x68, currentLO);
