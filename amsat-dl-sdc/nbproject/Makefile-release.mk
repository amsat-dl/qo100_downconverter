...
SOURCEFILES_QUOTED_IF_SPACED=src/driver/base/i2c.c src/driver/adf4351.c src/driver/i2c_native.c src/driver/lnb.c src/driver/usart.c src/driver/irq.c src/driver/si5328.c src/font8x8.c src/driver/lcd.c src/gps.c src/gpio.c src/driver/timer.c src/main.c src/pinmap.c src/freq_tables.c src/eeprom.c src/secretsettings.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/driver/base/i2c.p1 ${OBJECTDIR}/src/driver/adf4351.p1 ${OBJECTDIR}/src/driver/i2c_native.p1 ${OBJECTDIR}/src/driver/lnb.p1 ${OBJECTDIR}/src/driver/usart.p1 ${OBJECTDIR}/src/driver/irq.p1 ${OBJECTDIR}/src/driver/si5328.p1 ${OBJECTDIR}/src/font8x8.p1 ${OBJECTDIR}/src/driver/lcd.p1 ${OBJECTDIR}/src/gps.p1 ${OBJECTDIR}/src/gpio.p1 ${OBJECTDIR}/src/driver/timer.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/pinmap.p1 ${OBJECTDIR}/src/freq_tables.p1 ${OBJECTDIR}/src/eeprom.p1 ${OBJECTDIR}/src/secretsettings.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/driver/base/i2c.p1.d ${OBJECTDIR}/src/driver/adf4351.p1.d ${OBJECTDIR}/src/driver/i2c_native.p1.d ${OBJECTDIR}/src/driver/lnb.p1.d ${OBJECTDIR}/src/driver/usart.p1.d ${OBJECTDIR}/src/driver/irq.p1.d ${OBJECTDIR}/src/driver/si5328.p1.d ${OBJECTDIR}/src/font8x8.p1.d ${OBJECTDIR}/src/driver/lcd.p1.d ${OBJECTDIR}/src/gps.p1.d ${OBJECTDIR}/src/gpio.p1.d ${OBJECTDIR}/src/driver/timer.p1.d ${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/pinmap.p1.d ${OBJECTDIR}/src/freq_tables.p1.d ${OBJECTDIR}/src/eeprom.p1.d ${OBJECTDIR}/src/secretsettings.p1.d
...
# Source Files
SOURCEFILES=src/driver/base/i2c.c src/driver/adf4351.c src/driver/i2c_native.c src/driver/lnb.c src/driver/usart.c src/driver/irq.c src/driver/si5328.c src/font8x8.c src/driver/lcd.c src/gps.c src/gpio.c src/driver/timer.c src/main.c src/pinmap.c src/freq_tables.c src/eeprom.c src/secretsettings.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-release.mk dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-sdc.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/src/driver/timer.p1: src/driver/timer.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -D__RELEASE__ -xassembler-with-cpp -I"src" -v -mwarn=-3 -Wa,-a -DXPRJ_release=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/src/driver/timer.p1 src/driver/timer.c 
...
${OBJECTDIR}/src/secretsettings.p1: src/secretsettings.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/secretsettings.p1.d 
	@${RM} ${OBJECTDIR}/src/secretsettings.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -D__RELEASE__ -xassembler-with-cpp -I"src" -v -mwarn=-3 -Wa,-a -DXPRJ_release=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/src/secretsettings.p1 src/secretsettings.c 
	@-${MV} ${OBJECTDIR}/src/secretsettings.d ${OBJECTDIR}/src/secretsettings.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/secretsettings.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-sdc.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-sdc.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_release=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -D__RELEASE__ -xassembler-with-cpp -I"src" -v -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -mrom=default,-7dc0-7fff -mram=default,-5f4-5ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-sdc.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-sdc.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-sdc.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-sdc.${IMAGE_TYPE}.map  -DXPRJ_release=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -D__RELEASE__ -xassembler-with-cpp -I"src" -v -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-sdc.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
