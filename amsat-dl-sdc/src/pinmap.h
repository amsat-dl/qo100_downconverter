...
GPIO_DEFINE_PIN_H(PIN_SI5328_LOL)
GPIO_DEFINE_PIN_H(PIN_LED_SI_LOCK)
GPIO_DEFINE_PIN_H(PIN_LED3)
GPIO_DEFINE_PIN_H(PIN_SI5328_CS_CA)
...
GPIO_DEFINE_PIN_H(PIN_LED0)
GPIO_DEFINE_PIN_H(PIN_LED_ADF_LOCK)
GPIO_DEFINE_PIN_H(PIN_LED1)
GPIO_DEFINE_PIN_H(PIN_LED_LNB_GOOD)
GPIO_DEFINE_PIN_H(PIN_LED2)
